export const engineSections = [
  {
    title: "Revive Your Vehicle's Performance: Find Reliable Used Engines",
    paragraphs: [
  ...
  {
    title: "Used engines unlock the very heart of performance",
    paragraphs: [
      "At Used Auto Parts Pro, used engines with warranty are, rather, much more than just parts; they’re the heartbeat that beats for your unrealized potential.",
      "Visualize a powerful engine, whose quality’s protected with our seal of standard.",
  ...
  
  {
    ...
    paragraphs: [
      "All used engines for sale here come with a comprehensive warranty on the long block, or core, of the engine.",
  ...
  
  {
    ...
    paragraphs: [
      "Determine the value of junkyard engines on sale and the value of the salvage engines available on the market for sale without having to break the bank.",
      "Here at Used Auto Parts Pro, we understand the right engine needed in your car, and that is why we’re always ready with competitive prices that will not shortchange quality.",
  ...
  
  {
    ...
    paragraphs: [
      "If you need a venue that will enable you to find the used engines for sale near where you live, our online service will enable you to conduct a nice search and get what precisely fits your car’s needs, either locally or far away.",
