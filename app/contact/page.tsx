    ...
    <main className="w-full text-[#E8F3FF] px-3 sm:px-4 md:px-6 lg:px-10 xl:px-20 bg-[#07142B]">
      ...
      <SectionWrapper>
        <div className="space-y-4 sm:space-y-5 md:space-y-6 max-w-[900px] mx-auto w-full">
          ...
          <Paragraph>
            Discover a new level of service and support with Parts Central.
...
function Paragraph({ children }: { children: React.ReactNode }) {
  return (
    <p className="text-[14px] sm:text-[16px] md:text-[18px] lg:text-[20px] leading-[24px] sm:leading-[28px] md:leading-[30px] lg:leading-[32px] opacity-95 text-[#cacaca]">
      {children}
    </p>
  );
}
