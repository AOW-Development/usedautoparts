  ...
  return (
    <section className="w-full bg-gradient-to-br from-[#07142B] via-[#0A2F5C] to-[#001D3D] text-[#E8F3FF] py-8 sm:py-10 md:py-12 lg:py-14 px-4 sm:px-6 md:px-8 lg:px-10 flex flex-col items-center relative overflow-hidden">
      ...
      <div className="mb-4 sm:mb-5 md:mb-6 lg:mb-8 text-center relative z-10">
        <h2 className="text-[22px] sm:text-[26px] md:text-[32px] lg:text-[40px] font-semibold text-transparent bg-clip-text bg-gradient-to-r from-[#ffffff] via-[#ffffff] to-[#B3D9FF]">
          Why Choose Us?
        </h2>
      ...
      >
        <FeatureCard
          icon={<Search className="w-6 h-6 text-[#00A3FF]" strokeWidth={2.5} />}
...
function FeatureCard({
  ...
  return (
    ...
    >
      ...
      {/* Icon */}
      <div className="w-12 h-12 sm:w-12 sm:h-12 md:w-14 md:h-14 lg:w-16 lg:h-16 rounded-full border-2 border-[#00A3FF]/40 flex items-center justify-center bg-gradient-to-br from-[#00A3FF]/5 to-transparent transition-all duration-300 group-hover:border-[#00A3FF]/70 group-hover:from-[#00A3FF]/20 group-hover:scale-110 relative z-10">
        <div className="text-[#00A3FF] drop-shadow-lg group-hover:drop-shadow-[0_0_12px_rgba(0,163,255,0.8)]">
          {icon}
        </div>
      </div>

      <h3 className="text-[16px] sm:text-[17px] md:text-[18px] lg:text-[18px] font-semibold leading-tight mt-1 text-white transition-all duration-300 group-hover:text-[#0099FF] relative z-10">
        {title}
      </h3>

      <p className="text-[16px] leading-[26px] tracking-[0.015em] font-medium max-w-xs md:max-w-sm text-[#B3D9FF] transition-all duration-300 group-hover:opacity-100 relative z-10">
        {desc}
      </p>
    </div>
  );
