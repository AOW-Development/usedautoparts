      ...
      <div className="max-w-6xl mx-auto px-6 lg:px-0">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          <div className="space-y-4">
            ...
            <p className="text-[16px] lg:text-[18px] leading-[26px] tracking-[0.015em] font-medium text-[#B3D9FF] max-w-xs">
            ...
            <div className="space-y-2 text-[#B3D9FF]">
              <p className="text-[16px] lg:text-[18px] tracking-[0.015em] font-medium">
                US Toll Free:{" "}
          ...
          <div>
            <h3 className="mb-4 font-semibold text-[16px] lg:text-[18px]">
              Quick Links
            </h3>
              ...
              {quickLinks.map((link) => (
                <li key={link.label}>
                  <Link
                    ...
                    className="text-[16px] lg:text-[18px] tracking-[0.015em] font-medium text-[#B3D9FF] hover:text-[#00A3FF] transition-colors duration-200"
                  >
                    {link.label}
                  </Link>
                </li>
          ...
          <div className="space-y-6">
            ...
            {/* PAY SECURELY */}
            <div>
              <p className="mb-3 font-semibold text-[16px] lg:text-[18px]">
                Pay Securely With
              </p>
              <div className="flex items-center gap-2">
                {["discover", "mastercard", "visa", "american"].map((card) => (
                  <div key={card} className="relative h-6 w-10 bg-white rounded p-1">
                    <Image
                      src={`/footer/${card}.svg`}
                      alt={card}
                      fill
          ...
          {/* COLUMN 4 - ADDRESS */}
          <div className="space-y-4">
            <h3 className="font-semibold text-[16px] lg:text-[18px]">
              Our Address
            </h3>

            <div className="space-y-2 text-[#B3D9FF]">
              <p className="font-semibold text-white text-[16px] lg:text-[18px]">
                PartsCentral
              </p>
              ...
              <p className="pt-2">
                <a
                  ...
                  className="text-[#00A3FF] hover:underline font-semibold text-[16px] lg:text-[18px]"
                >
                  (888) 338-2540
                </a>
              </p>
              ...
              <p>
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-[#00A3FF] hover:underline font-semibold inline-flex items-center gap-1 text-[16px] lg:text-[18px]"
                >
                  View on Map →
                </a>
              </p>
